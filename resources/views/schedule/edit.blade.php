...
<div class="container mt-5 mb-5">
    ...
    <div class="row mb-1">
        <div class="col">
            <h1>Edycja:</h1>
            <input type="text" name="name" class="form-control form-control-lg mt-1 mb-1" value="{{$schedule->name}}" required/>
        </div>
        <div class="col">
            <a class="btn btn-secondary btn-lg" style="float: right; margin-left: 0.25rem" href="{{ route('scheduleManage') }}" role="button">Powrót</a>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col">
