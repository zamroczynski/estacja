...
@section('content')
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col mb-3"><a class="btn btn-secondary" style="float: right;"
                    href="{{ route('shiftList') }}">Powrót</a></div>
        </div>
        <div class="row">
            <div class="col">
                <form class="" id="shiftEditForm" action="{{ route('shiftUpdate', $shift->id) }}"
                    method="POST">
                    @csrf
                    <div class="form-group row mb-2">
                        <label for="name" class="col-sm-2 col-form-label col-form-label-lg d-none d-lg-block">Nazwa</label>
                        <div class="col-sm-10">
                            <input name="name" id="name" value="{{ $shift->name }}" type="text"
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input name="start" id="start" value="{{ $shift->start }}" type="time"
                                class="form-control form-control-lg"
                                placeholder="Od..." required />
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        <label for="stop" class="col-sm-2 col-form-label col-form-label-lg d-none d-lg-block">Do</label>
                        <div class="col-sm-10">
                            <input name="stop" id="stop" value="{{ $shift->stop }}" type="time"
                                class="form-control form-control-lg"
                                placeholder="Do..." required />
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input name="numberOfEmployees" id="numberOfEmployees" min="1"
                                value="{{ $shift->number_of_employees }}" type="number"
