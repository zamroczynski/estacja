...
<div class="container mt-5 mb-5">
    ...
    <div class="row mt-3">
        <div class="col">
            <a class="btn btn-secondary btn-lg mt-2" style="float: right;" href="{{ route('adminSchedule') }}" role="button">Powrót</a>
        </div>
    </div>
    <div class="row mt-5">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check fs-5">
                        <input class="form-check-input" type="checkbox" value="{{ $shift->id }}" name="shift[]" id="{{ $shift->name }}">
                        <label class="form-check-label" for="{{ $shift->name }}">
                            {{ $shift->name }} | {{ $shift->start }} - {{ $shift->stop }} | Liczba pracowników: {{ $shift->number_of_employees }}
                        </label>
                    </div>
                    @endforeach
                </div>
